...
b) Comentar na classe BibliotecaApplication da linha 19(CategoriaService categoriaService = context.getBean(CategoriaService.class);) até a linha 137(categoriaService.salvar(categoria);). Isso foi necessário para carregar as categorias pré-definidas. 
